/* =================================================================
   Dämmstoffe Weidenhof — Konfigurator
...
(function () {
  ...
  const RECS = {
    wand: {
      label: "Wand / Fassade",
      standard: { name: "Weidenhof Fassadenplatte EPS 035", dicke: 14, lambda: "035", preis: 18 },
      premium:  { name: "Weidenhof Fassadenwolle 032", dicke: 16, lambda: "032", preis: 27 },
      oeko:     { name: "Weidenhof Holzfaser Natur", dicke: 18, lambda: "040", preis: 34 },
    },
    dach: {
      label: "Dach / Decke",
      standard: { name: "Weidenhof Klemmfilz 035", dicke: 20, lambda: "035", preis: 14 },
      premium:  { name: "Weidenhof Steinwolle A1", dicke: 22, lambda: "032", preis: 24 },
      oeko:     { name: "Weidenhof Aufdach Holzfaser", dicke: 24, lambda: "040", preis: 38 },
    },
    boden: {
      label: "Boden / Geschossdecke",
      standard: { name: "Weidenhof Trittschall EPS", dicke: 8, lambda: "035", preis: 12 },
      premium:  { name: "Weidenhof Hartschaum PIR 024", dicke: 10, lambda: "024", preis: 26 },
      oeko:     { name: "Weidenhof Trittschall Holzfaser", dicke: 12, lambda: "040", preis: 30 },
    },
    keller: {
      label: "Keller / Perimeter",
      standard: { name: "Weidenhof Hartschaum XPS", dicke: 10, lambda: "035", preis: 19 },
      premium:  { name: "Weidenhof Perimeter XPS 300", dicke: 12, lambda: "032", preis: 29 },
      oeko:     { name: "Weidenhof Schaumglas Massiv", dicke: 12, lambda: "040", preis: 42 },
    },
  };
