/* =================================================================
   Dämmstoffe Weidenhof — shared interactions
   ================================================================= */
(function () {
  "use strict";
  ...
  window.WHInquiry = Inquiry; // expose for configurator
  Inquiry.render();
  ...
  if (form) {
    ...
    form.addEventListener("submit", (e) => {
      ...
      setTimeout(() => {
        window.location.href = "mailto:info@weidenhof-daemmstoffe.de?subject=" + subject + "&body=" + body;
      }, 600);
      form.reset();
    });
  }
